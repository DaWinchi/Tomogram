...
// Tomogram.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTomogramApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTomogramApp

CTomogramApp::CTomogramApp()
{
...
// Единственный объект CTomogramApp

CTomogramApp theApp;


// Инициализация CTomogramApp

BOOL CTomogramApp::InitInstance()
{
